...
<?php endif; ?></ul> </ul>  
    ...
    <!--<?php// echo $row1['fecha']; ?> -->
    <br><?php echo"<img src=\"modulos/buscador/documentos/".$row1['documento']."\"" ;?> 
    <br><br>
    <?php echo htmlentities(substr($row1['resumen'],0,300),null,"UTF-8");?>
    <?php endwhile; ?>
<br>
<hr>
   ...
   <!-- <?php// echo $row2['fecha']; ?>  -->
    <br><?php echo"<img src=\"modulos/buscador/documentos/".$row2['documento']."\"" ;?> 
    <br><?php echo htmlentities(substr($row2['resumen'],0,300),null,"UTF-8");?>
    <?php endwhile; ?>
<br>
<hr>   
   ...
   <h2> <a href="?mod=buscador&acc=detallediv3&id=<?php echo $row3['id']; ?>"> <?php echo $row3['titulo']; ?> </a> </h2>
     <?php echo $row3['fecha']; ?>
    <br><?php echo"<img src=\"modulos/buscador/documentos/".$row3['documento']."\"" ;?> 
    <br><?php echo $row3['resumen']; ?>  
    <?php endwhile; ?>
 <br>
<hr>

<?php $consulta7 = "SELECT * FROM div7 ORDER BY id DESC LIMIT 1" ; $res7 = mysql_query($consulta7); ?> <?php while($row7=mysql_fetch_array($res7)): ?>    
    <h2><a href="?mod=buscador&acc=detallediv7&id=<?php echo $row7['id']; ?>"> 
    <?php echo $row7['titulo']; ?> </a> </h2>
   <!-- <?php// echo $row7['fecha']; ?> -->
    <br><?php echo"<img src=\"modulos/buscador/documentos/".$row7['documento']."\"" ;?> 
    <br>
    <?php echo htmlentities(substr($row7['resumen'],0,300),null,"UTF-8");?>
    <?php endwhile; ?>
<br>
<hr>
...
<!--//////////////**********************     Imagenes  ******************//////////////////-->                
              ...
              <div id="image_section">
                        <a href="#"><img src="mas/img/logo malvinas.jpg" alt="image" whidt="100" height="100" /></a>
                        <a href="#"><img src="mas/img/florecen1000.jpg" alt="image" whidt="100" height="100"/></a>
    ...
    <?php echo $row4['fecha']; ?> 
    <br><?php echo"<img src=\"modulos/buscador/documentos/".$row4['documento']."\"" ;?> <br> 
    ...
    <br><?php echo"<img src=\"modulos/buscador/documentos/".$row5['documento']."\"" ;?> 
    <br><?php echo $row5['resumen']; ?>
    <?php endwhile; ?>
<br>
<hr>
...
<?php  $consulta6= "SELECT * FROM div6 ORDER BY id DESC LIMIT 1" ; $res6 = mysql_query($consulta6); ?> <?php while($row6=mysql_fetch_array($res6)): ?> 
   ...
   <?php echo $row6['fecha']; ?>
   <br><?php echo"<img src=\"modulos/buscador/documentos/".$row6['documento']."\"" ;?> 
   <br><?php echo $row6['resumen']; ?>
   <?php endwhile; ?>
    <br>
    <hr>


                    <div class="newsbox"><img src="images/templatemo_image_08.jpg" alt="image" />
                        <span class="newstitle">Nuevo Título 1</span><br />
                        <p>
            ...
            <div class="templatemo_rcol_sectionwithborder">
            	<div id="templatemo_newsletter_section">
                    ...
                    <form method="get" action="#">
                        ...
                        <select>
                            <option><a href="http://www.juandanielestevez.com.ar/repo/" target="_blanck">BASE DE DATOS </a></option>
            	...
            	<div id="templatemo_blog_section">
                    ...
                    <div class="blog_box">
                        <h3> 
                            ...
                            <br><hr>
                            <a href="http://portal1.chaco.gov.ar/" target="_blanck"><img src="mas/img/logo-chaco.jpg"></a>
                            <br><hr>    
