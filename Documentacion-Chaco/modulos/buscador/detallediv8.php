...
<?php
		...
		$consulta8 = "SELECT * FROM div8 ORDER BY id DESC LIMIT 1" ;
		$res8 = mysql_query($consulta8);
...
<div id="templatemo_container">
	...
	<div id="templatemo_content">
    	...
    	<div id="templatemo_main_leftcol">
		    ...
		    <h2><?php echo $row8['titulo']; ?></h2>

            <?php echo"<img src=\"modulos/buscador/documentos/".$row8['documento']."\"" ;?>
            <br>
            <!--<?php// echo $row1['fecha']; ?>-->
            <br>
