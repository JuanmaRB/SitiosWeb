...
<?php
		...
		$consulta6 = "SELECT * FROM div6 WHERE id = '".$_GET['id']."'";
		$res6 = mysql_query($consulta6);

	?>
			<?php while($row6=mysql_fetch_array($res6)): ?>
...
<div id="templatemo_container">
	...
	<div id="templatemo_content">
    	...
    	<div id="templatemo_main_leftcol">
		    ...
		    <h2><?php echo $row6['titulo']; ?></h2>

            <?php echo"<img src=\"modulos/buscador/documentos/".$row6['documento']."\" " ;?>
            <br>
            <!--<?php// echo $row1['fecha']; ?>-->
            <br>
