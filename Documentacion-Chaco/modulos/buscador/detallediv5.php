...
<?php
		...
		$consulta5 = "SELECT * FROM div5 WHERE id = '".$_GET['id']."'";
		$res5 = mysql_query($consulta5);
...
<div id="templatemo_container">
	...
	<div id="templatemo_content">
    	...
    	<div id="templatemo_main_leftcol">
		    ...
		    <h2><?php echo $row5['titulo']; ?></h2>

            <?php echo"<img src=\"modulos/buscador/documentos/".$row5['documento']."\"" ;?>
            <br>
            <!--<?php// echo $row1['fecha']; ?>-->
            <br>
