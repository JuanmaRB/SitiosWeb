...
<!--        columnas 1 2 3 7 de mi derecha  -->
    ...
    <?php $consulta2 = "SELECT * FROM div2 ORDER BY id DESC LIMIT 8" ; $res2 = mysql_query($consulta2); ?> <?php while($row2=mysql_fetch_array($res2)): ?>    
    <h2>
    <a href="?mod=buscador&acc=detallediv2&id=<?php echo $row2['id']; ?>"> <?php echo $row2['titulo']; ?> </a> 
    </h2>
    <!--<?php// echo $row1['fecha']; ?> -->
    <br>
    <?php echo"<img src=\"modulos/buscador/documentos/".$row2['documento']."\"height='130px' width='180px'  " ;?> 
    <br>
    <br>
    <p align="justify"><?php echo (substr($row2['resumen'],0,500));?></p>
    <br>
    <hr>    
    <hr>
    <?php endwhile; ?>
