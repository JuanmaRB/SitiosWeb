...
<!--        columnas 1 2 3 7 de mi derecha  -->
   ...
   Cátalogos |
   <hr>
    <?php $consulta6 = "SELECT * FROM div6 ORDER BY id DESC LIMIT 8" ; $res6 = mysql_query($consulta6); ?> <?php while($row6=mysql_fetch_array($res6)): ?>    
    <h2>
    <a href="?mod=buscador&acc=detallediv6&id=<?php echo $row6['id']; ?>"> <?php echo $row6['titulo']; ?> </a> 
    </h2>
    <!--<?php// echo $row1['fecha']; ?> -->
    <br>
    <?php echo"<img src=\"modulos/buscador/documentos/".$row6['documento']."\"height='130px' width='180px'  " ;?> 
    <br>
    <br>
    <p align="justify"><?php echo (substr($row6['resumen'],0,500));?></p>
    <br>
    <hr>    
    <hr>
    <?php endwhile; ?>
