...
<!--        columnas 1 2 3 7 de mi derecha  -->
    ...
    <?php $consulta3 = "SELECT * FROM div3 ORDER BY id DESC LIMIT 8" ; $res3 = mysql_query($consulta3); ?> <?php while($row3=mysql_fetch_array($res3)): ?>    
    <h2>
    <a href="?mod=buscador&acc=detallediv3&id=<?php echo $row3['id']; ?>"> <?php echo $row3['titulo']; ?> </a> 
    </h2>
    <!--<?php// echo $row1['fecha']; ?> -->
    <br>
    <?php echo"<img src=\"modulos/buscador/documentos/".$row3['documento']."\"height='130px' width='180px'  " ;?> 
    <br>
    <br>
    <p align="justify"><?php echo (substr($row3['resumen'],0,500));?></p>
    <br>
    <hr>    
    <hr>
    <?php endwhile; ?>
