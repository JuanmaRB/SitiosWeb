...
<!--        columnas 1 2 3 7 de mi derecha  -->
    ...
    <?php $consulta4 = "SELECT * FROM div4 ORDER BY id DESC LIMIT 8" ; $res4 = mysql_query($consulta4); ?> <?php while($row4=mysql_fetch_array($res4)): ?>    
    <h2>
    <a href="?mod=buscador&acc=detallediv4&id=<?php echo $row4['id']; ?>"> <?php echo $row4['titulo']; ?> </a> 
    </h2>
    <!--<?php// echo $row1['fecha']; ?> -->
    <br>
    <?php echo"<img src=\"modulos/buscador/documentos/".$row4['documento']."\"height='130px' width='180px'  " ;?> 
    <br>
    <br>
    <p align="justify"><?php echo (substr($row4['resumen'],0,500));?></p>
    <br>
    <hr>    
    <hr>
    <?php endwhile; ?>
